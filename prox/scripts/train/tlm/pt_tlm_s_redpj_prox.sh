...
srun python pretrain/tinyllama.py \
    --config_path configs/general/pt_tlm_s_redpj_prox.yaml

cd $TINYLM_WORK_DIR
conda activate tinylm
python -m scripts.weight_conversion.batch_model_conversion \
    --litgpt_model_dir pt_llama_0_7b_redpj_25B_prox \
    --hf_model_dir pt_llama_0_7b_redpj_25B_prox \
    --save_token_interval 1 \
    --arch_name tiny_LLaMA_0_7b
