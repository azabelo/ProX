...
# Patch https://github.com/huggingface/transformers/blob/v4.57.3/src/transformers/models/qwen2/modeling_qwen2.py
...
# ================================================================
# PATCH: Qwen2ForCausalLM.forward
...
def apply_veomni_qwen2_patch():
    ...
    from .device_patch import apply_veomni_qwen2_device_patch

    apply_veomni_qwen2_device_patch()
